...
import { AnnouncementRepository, UpdateAnnouncementInput } from 'src/domain/repositories/announcement.repository';

@Injectable()
export class UpdateAnnouncementUsecase {
  constructor(private readonly announcementRepository: AnnouncementRepository) {}

  async execute(id: string, data: UpdateAnnouncementInput, churchId: string): Promise<IAnnouncement> {
