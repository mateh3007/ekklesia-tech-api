...
@Module({
  imports: [PrismaModule, RegisterModule, ChurchModule, UserModule, AuthModule, PermissionModule, ChurchServiceModule, ChurchEventModule, InviteModule, AgendaModule],
  providers: [
