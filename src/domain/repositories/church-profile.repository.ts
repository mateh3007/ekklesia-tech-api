...
export type CreateChurchProfileInput = Omit<
  IChurchProfile,
  'id' | 'createdAt' | 'updatedAt' | 'deletedAt'
>;
export type UpdateChurchProfileInput = Partial<
  Omit<
    IChurchProfile,
    'id' | 'churchId' | 'createdAt' | 'updatedAt' | 'deletedAt'
  >
>;
...
export abstract class ChurchProfileRepository {
  ...
  abstract findByChurchIdIncludingDeleted(
    churchId: string,
