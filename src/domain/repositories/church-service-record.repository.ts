...
export type CreateChurchServiceRecordInput = Omit<
  IChurchServiceRecord,
  'id' | 'createdAt' | 'updatedAt' | 'deletedAt'
>;
export type UpdateChurchServiceRecordInput = Partial<
  Pick<
    IChurchServiceRecord,
    'serviceId' | 'preacher' | 'topic' | 'bibleVerse' | 'notes' | 'date'
  >
>;
